...
-(void)drawSerie:(Chart *)chart serie:(NSMutableDictionary *)serie{
 ...
 //   KTLog(@"-----------------------------%@",[serie objectForKey:@"label"]);
...
//    
    ...
    for(int i=chart.rangeFrom;i<data.count;i++){
        ...
        if (i<chart.rangeTo-1 && [data objectAtIndex:(i+1)] != nil) {
            ...
            if ([label isEqualToString:@"MA5"]) {
                
                 CGContextSetStrokeColorWithColor(context, [UIColor colorWithRed:0.85f green:0.80f blue:0.5f alpha:1.00f].CGColor);
            }else if([label isEqualToString:@"MA10"]){
                
                 CGContextSetStrokeColorWithColor(context, [UIColor colorWithRed:0.21f green:0.02f blue:0.81f alpha:1.00f].CGColor);
            }else if([label isEqualToString:@"MA20"]){
                
                 CGContextSetStrokeColorWithColor(context, [UIColor colorWithRed:0.33f green:0.76f blue:0.75f alpha:1.00f].CGColor);
            }else{
                
                 CGContextSetStrokeColorWithColor(context, [UIColor colorWithRed:0.85f green:0.80f blue:0.50f alpha:1.00f].CGColor);
            }
