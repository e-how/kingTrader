...
//        KTLog(@"rangeFrom滴滴滴滴滴滴     %d",chart.rangeFrom);
        ...
        if (!isnan(sec.frame.origin.x+sec.paddingLeft+(chart.selectedIndex-chart.rangeFrom)*chart.plotWidth+chart.plotWidth/2) && !isnan(sec.frame.origin.y+sec.paddingTop)) {
