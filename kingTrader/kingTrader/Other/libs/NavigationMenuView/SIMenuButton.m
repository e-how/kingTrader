...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.title.textColor = [UIColor colorWithRed:0.93f green:0.82f blue:0.59f alpha:1.00f];
...
//    [self.title sizeToFit];
    ...
    self.arrow.center = CGPointMake(self.frame.size.width/2, self.frame.size.height-8.0);
}
